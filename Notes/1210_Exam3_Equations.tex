...
\begin{center}
	...
	{\LARGE Exam 3 (Chapters 5-6) Spring 2026}
\end{center}
...
\begin{minipage}[c][\stretch{1}][c]{0.495\linewidth}
	...
	\end{equation*}
\end{minipage}
\rule[-135pt]{1.5pt}{270pt}
\begin{minipage}[c][\stretch{1}][c]{0.495\linewidth}
	\begin{equation*}
		q=n_{rxn}\Delta H_{rxn} \hspace{2em} \left(n_{rxn}=\frac{n_{limiting}}{\nu_{limiting}}\right)
	\end{equation*}

	\begin{equation*}
		\Delta H_{rxn}	= \frac{-mc\Delta T}{n_{rxn}}
	\end{equation*}
...
\hspace{6em}	\includegraphics[width=1.28\textwidth, angle =90]{UpdatedTable}
